...
export default function ProfilePage() {
  ...
  if (!session || !session.user) {
    return (
      <div className="hero-page-shell min-h-screen bg-[#07090e] text-white flex flex-col items-center justify-center px-4">
  ...
  return (
    <div className="hero-page-shell min-h-screen bg-[#07090e] text-white flex flex-col selection:bg-blue-500/30">
      <ScrollProgress />
      <Navbar />

      <main className="reference-editorial-section flex-grow pt-32 pb-24 px-4 sm:px-6 lg:px-8 max-w-[1320px] mx-auto w-full space-y-8">
        {/* Profile Banner */}
        <div className="border border-white/12 bg-white/[0.035] p-6 sm:p-8 flex flex-col sm:flex-row items-start sm:items-center justify-between gap-6">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
          {/* Profile Card */}
          <div className="p-6 border border-white/12 bg-white/[0.025] space-y-6 self-start">
