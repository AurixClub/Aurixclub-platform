...
export default function AdminPage() {
  ...
  if (isLoading) {
    return (
      <div className="hero-page-shell min-h-screen bg-[#07090e] text-white flex items-center justify-center">
  ...
  if (!session || !session.user || session.user.role !== "super_admin") {
    return (
      <div className="hero-page-shell min-h-screen bg-[#07090e] text-white flex flex-col items-center justify-center px-4 relative">
  ...
  return (
    <div className="hero-page-shell min-h-screen bg-[#07090e] text-white flex flex-col selection:bg-violet-500/30">
      {/* Top Header */}
      ...
      {/* Main Content Area */}
      <main className="reference-editorial-section flex-1 max-w-[1320px] mx-auto px-4 sm:px-6 lg:px-8 py-10 w-full">
        {/* ─── TAB: OVERVIEW ────────────────────────────────────────────── */}
        {activeTab === "overview" && (
