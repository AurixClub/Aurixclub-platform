...
export default function AuthCallbackPage() {
  ...
  return (
    <main className="hero-page-shell reference-editorial-section min-h-screen bg-[#07090e] text-white flex items-center justify-center px-6">
      <div className="w-full max-w-md border border-white/12 bg-white/[0.035] p-8 text-center space-y-5">
        <span className="mx-auto block h-10 w-10 rounded-full border-2 border-white/15 border-t-white animate-spin" />
